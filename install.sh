...
print_banner() {
  echo ""
  echo -e "${CYAN}    __  _______  ____________________  __  ____  ______${NC}"
  echo -e "${CYAN}   /  |/  / __ \\/ ____/ ____/  _/ __ \/ / / / / /_  __/${NC}"
  echo -e "${CYAN}  / /|_/ / / / / /   / /    / // /_/ / / / / /   / /   ${NC}"
  echo -e "${CYAN} / /  / / /_/ / /___/ /____/ // ____/ /_/ / /___/ /    ${NC}"
  echo -e "${CYAN}/_/  /_/\\____/\\____/\\____/___/_/    \\____/_____/_/     ${NC}"
  echo ""
